# DOC_02 — Doctor Profiles / Fiches des médecins
...
## 2.1 — Emergency / Urgence
`chunk_id: doc02_emergency` · `lang: fr,en` · `priority: highest`
...
## 2.3 — Dr Sana Amraoui
`chunk_id: doc02_amraoui` · `lang: fr,en`

**FR —**
- **Nom & titre :** Dr Sana Amraoui, fondatrice et directrice médicale de Cardio Check-up.
- **Spécialité :** cardiologue et rythmologue interventionnelle (spécialiste du rythme cardiaque / électrophysiologiste).
- **Ce qu'elle prend en charge :** troubles du rythme cardiaque (notamment la fibrillation atriale), bilan cardiovasculaire complet, et les actes de rythmologie : ablation par cathéter, pose et suivi de pacemaker et de défibrillateur, holter implantable.
...
**EN —**
- **Name & title:** Dr Sana Amraoui, founder and medical director of Cardio Check-up.
- **Specialty:** cardiologist and interventional electrophysiologist (heart-rhythm specialist).
- **What she handles:** heart-rhythm disorders (notably atrial fibrillation), the complete cardiovascular check-up, and rhythm procedures: catheter ablation, pacemaker and defibrillator implantation and follow-up, implantable Holter (loop recorder).
...
## 2.4 — Pr Fabien Doguet
`chunk_id: doc02_doguet` · `lang: fr,en`

**FR —**
- **Nom & titre :** Pr Fabien Doguet.
- **Spécialité :** chirurgien cardiaque (chirurgie du cœur).
- **Ce qu'il prend en charge :** chirurgie cardiaque mini-invasive (valve mitrale, valve aortique), pontages coronaires, chirurgie de l'aorte.
...
**EN —**
- **Name & title:** Pr Fabien Doguet.
- **Specialty:** cardiac surgeon (heart surgery).
- **What he handles:** minimally invasive heart surgery (mitral valve, aortic valve), coronary bypass, aortic surgery.
...
## 2.5 — Dr Leslie Berdah Sadaoui
`chunk_id: doc02_berdah_sadaoui` · `lang: fr,en`

**FR —**
- **Nom & titre :** Dr Leslie Berdah Sadaoui.
- **Spécialité :** médecin généraliste.
- **Ce qu'elle prend en charge :** nutrition, surpoids, prévention cardiovasculaire, bilan de santé.
...
**EN —**
- **Name & title:** Dr Leslie Berdah Sadaoui.
- **Specialty:** general practitioner (GP).
- **What she handles:** nutrition, weight management, cardiovascular prevention, general health check-ups.
...
## 2.6 — Dr Adam Taha
`chunk_id: doc02_taha` · `lang: fr,en`
...
## 2.7 — Dr Hakem Rabiaa
`chunk_id: doc02_hakem_rabiaa` · `lang: fr,en`
